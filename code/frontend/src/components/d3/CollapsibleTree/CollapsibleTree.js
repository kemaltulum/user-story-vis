                                    ...
                                    return (
                                        ...
                                        */
                                        <g key={config.x + "-" + config.y} className="node" transform={`translate(${config.y}, ${config.x})`}>
                                            <g>
                                                <rect height="55" width="136" y="2" x="2" stroke-width="1.5" stroke="#261D3D" fill="#a8a3b1" />
                                                {
                                                    ((config.data.children && config.data.children.length > 0) || (config.data.children2 && config.data.children2.length > 0)) &&
                                                    <Fragment>
                                                        <rect className="node-cursor" onClick={this.handleGroupClick.bind(this, config.data)} rx="15" id="svg_3" height="55" width="27" y="2" x="128" fill-opacity="null" stroke-opacity="null" stroke-width="1.5" stroke="#261D3D" fill="#261D3D" />
                                                        {
                                                        ...
                                                        }
                                                        {
                                                            ...
                                                            <path className="node-cursor" onClick={this.handleGroupClick.bind(this, config.data)} d="m136.068832,43.620384l-2.59021,-2.617714l-2.588882,-2.618797l2.59024,-2.620651l2.588852,-2.618637l0,2.912262c0.634644,0 1.371964,0 1.619019,0c1.177826,0.058113 2.631546,-1.566666 4.178146,-3.661186c0.576538,-0.734396 1.158203,-1.542364 1.774643,-2.271933c-0.61644,-0.730408 -1.19722,-1.537476 -1.774643,-2.271835c-1.5466,-2.091599 -3.00032,-3.719345 -4.176544,-3.660141l-1.620621,-0.000969l0,2.916115l-2.588852,-2.61969l-2.59024,-2.621704l2.59024,-2.624466l2.588852,-2.620651l0,2.914246l1.619736,0c2.405655,0.059059 4.203537,2.563507 5.776794,4.598969c1.561798,2.147858 2.965622,3.764832 3.779846,3.660172l4.644531,0l0,4.652327l-4.646057,0c-0.813507,-0.105713 -2.218048,1.512314 -3.779678,3.66011c-1.57254,2.03653 -3.369781,4.538857 -5.776154,4.599007l-1.619019,0l0,2.915169l0,0z" stroke-opacity="null" stroke-width="1" stroke="#fff" fill="#261D3D" />
                                                        }
                                                    </Fragment>
                                                }
                                                {
                                                    ((config.data.children && config.data.children.length > 0) || (config.data.children2 && config.data.children2.length > 0)) ?
                                                        <rect className="node-cursor" height="13" width="82.230823" y="43.461531" x="2.615396" stroke-opacity="null" stroke-width="1" stroke="#261D3D" fill="#261D3D" />  :
                                                        <rect className="node-cursor" height="13" width="136" y="43.461531" x="2.615396" stroke-opacity="null" stroke-width="1" stroke="#261D3D" fill="#261D3D" />
                                                }
                                                <text className="node-cursor" text-anchor="start" font-family="Helvetica, Arial, sans-serif" font-size="10" id="svg_7" y="53.076916" x="27.615463" fill-opacity="null" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#fff">Stories</text>                                                
                                                <text transform="matrix(0.970731, 0, 0, 1, 0.321963, 0)" text-anchor="start" font-family="Helvetica, Arial, sans-serif" font-size={this.font(config.data.name)} id="svg_9" y="28" x="11" fill-opacity="null" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#000000">
                                                    {this.short(config.data.name)}
                                                    <title>{config.data.name}</title>
                                                </text>
                                            </g>
                                ...
                                linksConfig => {
                                    return (
                                        <path key={linksConfig.source.x + "-" + linksConfig.source.y + "-" + linksConfig.target.x + "-" + linksConfig.target.y} 
                                            fill="none" stroke="#261D3D" stroke-width="1.5" className="link"
