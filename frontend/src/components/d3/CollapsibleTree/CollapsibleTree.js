                                            ...
                                            <g>
                                                ...
                                                }
                                                {
                                                    ...
                                                    <Fragment>
                                                        {
                                                            ((config.data.children && config.data.children.length > 0) || (config.data.children2 && config.data.children2.length > 0)) ?
                                                                <rect onClick={this.handleStoriesClick.bind(this, config.data.stories)} className="node-cursor" height="18" width="82.230823" y="39.461531" x="2.615396" strokeOpacity="null" strokeWidth="1" stroke={this.state.strokeColor} fill={this.state.normalColor} /> :
                                                                <rect onClick={this.handleStoriesClick.bind(this, config.data.stories)} className="node-cursor" height="18" width="136" y="39.461531" x="2.615396" strokeOpacity="null" strokeWidth="1" stroke={this.state.strokeColor} fill={this.state.normalColor} />
                                                        }
                                ...
                                linksConfig => {
                                    return (
                                        <path key={linksConfig.source.x + "-" + linksConfig.source.y + "-" + linksConfig.target.x + "-" + linksConfig.target.y} 
                                            fill="none" stroke={this.state.strokeColor} strokeWidth="1.5" className="link"
